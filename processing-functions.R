#### FUNCTIONS FOR PROCESSING AGVENTURE DATA ####
...
ne.mods <- function(data) {
  data %>%
    ...
    mutate(
      group_level2 =
        ifelse(group_level2 == "Nitrogen Emissions",
          "Growing Season N2O Emissions",
          group_level2
        )
    ) %>%
    mutate(
      group_level2 =
        ifelse(group_level2_alt == "Nitrogen Emissions",
          "Growing Season N2O Emissions",
          group_level2_alt
        )
    ) %>%
    mutate(
      group_level2 =
        ifelse(group_level2 == "Carbon Emissions" | group_level2 == "Carbon Storage",
          "Carbon",
          group_level2
        )
    ) %>%
    mutate(
      group_level2_alt =
        ifelse(group_level2_alt == "Carbon Emissions" | group_level2_alt == "Carbon Storage",
          "Carbon",
          group_level2_alt
        )
    ) %>%
    ...
    mutate(
      group_level2 =
        ifelse(group_level2 == "Soil Structure",
          "Physical Properties",
          group_level2
        )
    ) %>%
    mutate(
      group_level2_alt =
        ifelse(group_level2_alt == "Soil Structure",
          "Physical Properties",
          group_level2_alt
        )
    ) %>%
    ...
    mutate(
      group_level2_alt =
        ifelse(group_level2_alt == "Corn root biomass",
          "Corn root development",
          group_level2_alt
        )
    ) %>%
    ...
    mutate(
      group_level3 =
        ifelse(group_level3 == "Respiration" | group_level3 == "Carbon Dioxide (CO2)",
          "Carbon Dioxide",
          group_level3
        )
    ) %>%
    mutate(
      norm_interp3 =
        ifelse(group_level3 == "Enzyme activity",
    ...
    mutate(
      group_level3 =
        ifelse(group_level3 == "Nitrous oxide (N20)",
          "Nitrous oxide (N2O)",
          group_level3
        )
    )
