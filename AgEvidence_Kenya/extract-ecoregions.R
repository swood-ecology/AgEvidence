...
# Add data
kenya_ecoregions <- st_read("spatial-data/Ecozone Map Layers/Kenya_Ecoregions.shp", crs = 4326) %>% 
  st_make_valid()
kenya_farming_systems <- st_read("spatial-data/FAO_Farming-Systems_KE/fao_farming-systems_ke.shp", crs = 4326) %>% 
  st_make_valid()
